		...
		if (point) {
			...
			var j,
				...
				frame = function() {
					...
					if (!data.effect || !data.effect.animating)
						return;
					...
					for (j = 0; j < len; j++)
						v.push(point.easing(1, timeDiff, point.from[j], diff[j], point.duration));

 ...
 *
 * Copyright (C) 2012 Emmanuel Garcia - 2021 Raffaele Morganti
 * All rights reserved
 **/
  ...
  destroy: function () {
    ...
    var page,
      ...
      events = [
        ...
        'released', 'start', 'turning', 'turned', 'missing'];
  ...
  _fold: function(point) {
    ...
    switch (data.effect) {
      ...
      compute = function() {
        ...
        var alpha =  Math.PI/2-Math.atan2(rel.y, rel.x),
          ...
          if (alpha>Math.PI/2) {
            var beta = Math.PI-alpha, dd = h - height/Math.sin(beta);
        ...
        // Gradients
          if (turnData.opts.gradients) {
            ...
            shadowVal = Math.sin(Math.PI/2*((far>1) ? 2 - far : far));

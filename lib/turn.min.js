...
window||"MozPerspective"in document.body.style;z=R();var b,c=this,d=0,e=this.data(),f=this.children(),a=g.extend({width:this.width(),height:this.height(),direction:this.attr("dir")||this.css("direction")},U,a);e.opts=a;e.pageObjs={};e.pages={};e.pageWrap={};e.pagePlace={};e.pageMv=[];e.zoom=1;e.totalPages=a.pages||0;e.eventHandlers={mouseStart:function(){for(var a in e.pages)if(n(a,e.pages)&&!1===i._eventStart.apply(e.pages[a],arguments))return!1},mouseMove:function(){for(var a in e.pages)n(a,e.pages)&&
i._eventMove.apply(e.pages[a],arguments)},mouseEnd:function(){for(var a in e.pages)n(a,e.pages)&&i._eventEnd.apply(e.pages[a],arguments)},start:function(){return h._start.apply(c,arguments)}};if(a.when)for(b in a.when)n(b,a.when)&&this.bind(b,a.when[b]);this.css({position:"relative",width:a.width,height:a.height});this.turn("display",a.display);C&&(!w&&a.acceleration)&&this.transform(r(0,0,!0));for(b=0;b<f.length;b++)"1"!=g(f[b]).attr("ignore")&&this.turn("addPage",f[b],++d);g(this).bind(t.down,e.eventHandlers.mouseStart).bind("end",
h._end).bind("pressed",h._pressed).bind("released",h._released).bind("flip",h._flip);g(this).parent().bind("start",e.eventHandlers.start);g(document).bind(t.move,e.eventHandlers.mouseMove).bind(t.up,e.eventHandlers.mouseEnd);""!==a.direction&&this.turn("direction",a.direction);this.turn("page",a.page);e.done=!0;return this},addPage:function(a,b){var c,d=!1,e=this.data(),f=e.totalPages+1;if(e.destroying)return!1;if(c=/\bp([0-9]+)\b/.exec(g(a).attr("class")))b=parseInt(c[1],10);if(b)if(b==f)d=!0;else{if(b>
f)throw p('Page "'+b+'" cannot be inserted');}else b=f,d=!0;1<=b&&b<=f&&(c="double"==e.display?b%2?" odd":" even":"",e.done&&this.turn("stop"),b in e.pageObjs&&h._movePages.call(this,b,1),d&&(e.totalPages=f),e.pageObjs[b]=g(a).css({"float":"left"}).addClass("page p"+b+c),h._addPage.call(this,b),h._removeFromDOM.call(this));return this},_addPage:function(a){var b=this.data(),c=b.pageObjs[a];if(c)if(h._necessPage.call(this,a)){if(!b.pageWrap[a]){var d=h._pageSize.call(this,a,!0);c.css({width:d.width,
height:d.height});b.pagePlace[a]=a;b.pageWrap[a]=g("<div/>",{"class":"page-wrapper",page:a,css:{position:"absolute",overflow:"hidden"}}).css(d);this.append(b.pageWrap[a]);b.pageObjs[a].appendTo(b.pageWrap[a])}h._makeFlip.call(this,a)}else b.pagePlace[a]=0,b.pageObjs[a]&&b.pageObjs[a].remove()},hasPage:function(a){return n(a,this.data().pageObjs)},center:function(a){var b=this.data(),c=g(this).turn("size"),d=c.width/(2*b.zoom)-c.width/2;b.noCenter||("double"==b.display&&(a=this.turn("view",a||b.tpage||
b.page),"ltr"==b.direction?a[0]?a[1]||(d+=c.width/4):d-=c.width/4:a[0]?a[1]||(d-=c.width/4):d+=c.width/4),g(this).css({marginLeft:d}));return this},destroy:function(){var a=this,b=this.data(),c="end first flip last pressed released start turning turned zooming missing".split(" ");if("prevented"!=v("destroying",this)){b.destroying=!0;g.each(c,function(b,c){a.unbind(c)});this.parent().unbind("start",b.eventHandlers.start);for(g(document).unbind(t.move,b.eventHandlers.mouseMove).unbind(t.up,b.eventHandlers.mouseEnd);0!==
b.totalPages;)this.turn("removePage",b.totalPages);b.fparent&&b.fparent.remove();b.shadow&&b.shadow.remove();this.removeData();b=null;return this}},is:function(){return"object"==typeof this.data().pages},zoom:function(a){var b=this.data();if("number"==typeof a){if(0.0010>a||100<a)throw p(a+" is not a value for zoom");if("prevented"==v("zooming",this,[a,b.zoom]))return this;var c=g(this).turn("size"),d=1/b.zoom,e=Math.round(c.width*d*a),f=Math.round(c.height*d*a);b.zoom=a;g(this).turn("stop").turn("size",
e,f).css({marginTop:c.height*d/2-f/2});b.opts.autoCenter?this.turn("center"):g(this).css({marginLeft:c.width*d/2-e/2});h._updateShadow.call(this);return this}return b.zoom},_pageSize:function(a,b){var c=this.data(),d={};if("single"==c.display)d.width=this.width(),d.height=this.height(),b&&(d.top=0,d.left=0,d.right="auto");else{var e=this.width()/2,f=this.height();c.pageObjs[a].hasClass("own-size")?(d.width=c.pageObjs[a].width(),d.height=c.pageObjs[a].height()):(d.width=e,d.height=f);if(b){var g=a%
2;d.top=(f-d.height)/2;"ltr"==c.direction?(d[g?"right":"left"]=e-d.width,d[g?"left":"right"]="auto"):(d[g?"left":"right"]=e-d.width,d[g?"right":"left"]="auto")}}return d},_makeFlip:function(a){var b=this.data();if(!b.pages[a]&&b.pagePlace[a]==a){var c="single"==b.display,d=a%2;b.pages[a]=b.pageObjs[a].css(h._pageSize.call(this,a)).flip({page:a,next:d||c?a+1:a-1,turn:this,duration:b.opts.duration,acceleration:b.opts.acceleration,gradients:b.opts.gradients}).flip("disable",b.disabled);h._setPageLoc.call(this,
a)}return b.pages[a]},_makeRange:function(){var a,b;if(!(1>this.data().totalPages)){b=this.turn("range");for(a=b[0];a<=b[1];a++)h._addPage.call(this,a)}},range:function(a){var b,c,d,e=this.data(),a=a||e.tpage||e.page||1;d=h._view.call(this,a);if(1>a||a>e.totalPages)throw p('"'+a+'" is not a page for range');d[1]=d[1]||d[0];1<=d[0]&&d[1]<=e.totalPages?(a=Math.floor(2),e.totalPages-d[1]>d[0]?(b=Math.min(d[0]-1,a),c=2*a-b):(c=Math.min(e.totalPages-d[1],a),b=2*a-c)):c=b=5;return[Math.max(1,d[0]-b),Math.min(e.totalPages,
...
delete b.pages[a]}b.pageObjs[a]&&b.pageObjs[a].remove();b.pageWrap[a]&&(b.pageWrap[a].remove(),delete b.pageWrap[a]);h._removeMv.call(this,a);delete b.pagePlace[a]},removePage:function(a){var b=this.data();if(1>a||a>b.totalPages)throw p("The page "+a+" doesn't exist");b.pageObjs[a]&&(this.turn("stop"),h._removePageFromDOM.call(this,a),delete b.pageObjs[a]);h._movePages.call(this,a,-1);b.totalPages-=1;b.page>b.totalPages?this.turn("page",b.totalPages):h._makeRange.call(this);return this},_movePages:function(a,
b){var c,d=this,e=this.data(),f="single"==e.display,g=function(a){var c=a+b,g=c%2,k=g?" odd ":" even ";e.pageObjs[a]&&(e.pageObjs[c]=e.pageObjs[a].removeClass("p"+a+" odd even").addClass("p"+c+k));e.pagePlace[a]&&e.pageWrap[a]&&(e.pagePlace[c]=c,e.pageWrap[c]=e.pageObjs[c].hasClass("fixed")?e.pageWrap[a].attr("page",c):e.pageWrap[a].css(h._pageSize.call(d,c,!0)).attr("page",c),e.pages[a]&&(e.pages[c]=e.pages[a].flip("options",{page:c,next:f||g?c+1:c-1})),b&&(delete e.pages[a],delete e.pagePlace[a],
delete e.pageObjs[a],delete e.pageWrap[a],delete e.pageObjs[a]))};if(0<b)for(c=e.totalPages;c>=a;c--)g(c);else for(c=a;c<=e.totalPages;c++)g(c)},display:function(a){var b=this.data(),c=b.display;if("undefined"==typeof a)return c;if(-1==g.inArray(a,S))throw p('"'+a+'" is not a value for display');switch(a){case "single":b.pageObjs[0]||(this.turn("stop").css({overflow:"hidden"}),b.pageObjs[0]=g("<div />",{"class":"page p-temporal"}).css({width:this.width(),height:this.height()}).appendTo(this));this.addClass("shadow");
...
10)||0});return this},_cAllowed:function(){var a=this.data().f,b=a.opts.page,c=b%2;if("hard"==a.effect)return"ltr"==d.direction?[c?"r":"l"]:[c?"l":"r"];var d=a.opts.turn.data();return"single"==d.display?1==b?"ltr"==d.direction?q.forward:q.backward:b==d.totalPages?"ltr"==d.direction?q.backward:q.forward:q.all:"ltr"==d.direction?q[c?"forward":"backward"]:q[c?"backward":"forward"]},_cornerActivated:function(a){var b=this.data().f,c=this.width(),d=this.height(),a={x:a.x,y:a.y},e=b.opts.cornerSize;if(0>=
a.x||0>=a.y||a.x>=c||a.y>=d)return!1;var f=i._cAllowed.call(this);switch(b.effect){case "hard":if(a.x>c-e)a.corner="r";else if(a.x<e)a.corner="l";else return!1;break;case "sheet":if(a.y<e)a.corner="t";else if(a.y>=d-e)a.corner="b";else return!1;if(a.x<=e)a.corner+="l";else if(a.x>=c-e)a.corner+="r";else return!1}return-1==g.inArray(a.corner,f)?!1:a},_isIArea:function(a){var b=this.data().f.parent.offset(),a=w&&a.originalEvent?a.originalEvent.touches[0]:a;return i._cornerActivated.call(this,{x:a.pageX-
b.left,y:a.pageY-b.top})},_c:function(a,b){b=b||0;switch(a){case "tl":return j(b,b);case "tr":return j(this.width()-b,b);case "bl":return j(b,this.height()-b);case "br":return j(this.width()-b,this.height()-b);case "l":return j(b,0);case "r":return j(this.width()-b,0)}},_c2:function(a){switch(a){case "tl":return j(2*this.width(),0);case "tr":return j(-this.width(),0);case "bl":return j(2*this.width(),this.height());case "br":return j(-this.width(),this.height());case "l":return j(2*this.width(),0);
...
this.data().f,c=i._c.call(this,a.corner),d=this.width(),e=this.height();switch(b.effect){case "hard":a.x="l"==a.corner?Math.min(Math.max(a.x,0),2*d):Math.max(Math.min(a.x,d),-d);var f,g,h,O,l,o=b.opts.turn.data().totalPages,n=b.opts["z-index"]||o,p={overflow:"visible"},E=c.x?(c.x-a.x)/d:a.x/d,q=90*E,t=90>q;switch(a.corner){case "l":O="0% 50%";l="100% 50%";t?(f=0,g=0<b.opts.next-1,h=1):(f="100%",g=b.opts.page+1<o,h=0);break;case "r":O="100% 50%",l="0% 50%",q=-q,d=-d,t?(f=0,g=b.opts.next+1<o,h=0):(f=
"-100%",g=1!=b.opts.page,h=1)}p[z+"perspective-origin"]=l;b.wrapper.transform("rotateY("+q+"deg)translate3d(0px, 0px, "+(this.attr("depth")||0)+"px)",l);b.fpage.transform("translateX("+d+"px) rotateY("+(180+q)+"deg)",O);b.parent.css(p);t?(E=-E+1,b.wrapper.css({zIndex:n+1}),b.fpage.css({zIndex:n})):(E-=1,b.wrapper.css({zIndex:n}),b.fpage.css({zIndex:n+1}));b.opts.gradients&&(g?b.ashadow.css({display:"",left:f,backgroundColor:"rgba(0,0,0,"+0.5*E+")"}).transform("rotateY(0deg)"):b.ashadow.hide(),b.bshadow.css({opacity:-E+

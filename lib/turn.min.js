...
this,b=this.data();if("prevented"!=u("destroying",this)){b.destroying=!0;g.each("end,first,flip,last,pressed,released,start,turning,turned,zooming,missing".split(","),function(b,d){a.unbind(d)});this.parent().unbind("start",b.eventHandlers.start);for(g(document).unbind(s.move,b.eventHandlers.mouseMove).unbind(s.up,b.eventHandlers.mouseEnd);0!==b.totalPages;)this.turn("removePage",b.totalPages);b.fparent&&b.fparent.remove();b.shadow&&b.shadow.remove();this.removeData();b=null;return this}},is:function(){return"object"==
...
(new Date).getTime()},_released:function(a,b){a.stopPropagation();var c,d=g(a.target),e=d.data().f,f=e.opts.turn,k=f.data();c="single"==k.display?"br"==b.corner||"tr"==b.corner?b.x<d.width()/2:b.x>d.width()/2:0>b.x||b.x>d.width();k.mouseAction=!1;if(200>(new Date).getTime()-e.time||c)a.preventDefault(),h._turnPage.call(f,e.opts.next,!1===i._cornerActivated.call(d,b,1))},_flip:function(a){a.stopPropagation();a=g(a.target).data().f.opts;a.turn.trigger("turn",[a.next]);a.turn.data().opts.autoCenter&&
...
1,display:""});break;case 0:b.pageWrap[a].css({zIndex:0,display:b.pageObjs[a].hasClass("fixed")?"":"none"})}return d},options:function(){return this.data().opts},version:function(){return"4.0.6"}},i={init:function(a){this.data({f:{disabled:!1,hover:!1,effect:this.hasClass("hard")?"hard":"sheet"}});this.flip("options",a);i._addPageWrapper.call(this);return this},setData:function(a){var b=this.data();b.f=g.extend(b.f,a);return this},options:function(a){var b=this.data().f;return a?(i.setData.call(this,
...
!1),i._foldingPage.call(this).appendTo(b.fpage),e[d]=b.opts.page,b.folding=d),c.turn("update")):b.folding&&(d.pages[b.folding]?(c=d.pages[b.folding].data().f,d.pageObjs[b.folding].appendTo(c.wrapper)):d.pageWrap[b.folding]&&d.pageObjs[b.folding].appendTo(d.pageWrap[b.folding]),b.folding in e&&(e[b.folding]=b.folding),delete b.folding)}},_showFoldedPage:function(a,b){var c=i._foldingPage.call(this),d=this.data(),e=d.f;if(e){if((!e.point||e.point.corner!=a.corner)&&"prevented"==u("start",this,[e.opts,
a.corner]))return!1;if(c){if(b){var f=this,c=e.point&&e.point.corner==a.corner?e.point:i._c.call(this,a.corner,1);this.animatef({from:[c.x,c.y],to:[a.x,a.y],duration:500,frame:function(b){a.x=Math.round(b[0]);a.y=Math.round(b[1]);i._fold.call(f,a)}})}else i._fold.call(this,a),d.effect&&!d.effect.turning&&this.animatef(!1);if(!e.visible)switch(e.effect){case "hard":e.visible=!0;i._moveFoldingPage.call(this,!0);e.fpage.show();e.opts.shadows&&e.bshadow.show();break;case "sheet":e.visible=!0,e.fparent.show().data().flips++,
...
this.data().effect.turning},corner:function(){return this.data().f.corner},_eventStart:function(a){var b=this.data().f,c=b.opts.turn;if(!b.disabled&&!this.flip("isTurning")&&b.opts.page==c.data().pagePlace[b.opts.page]){b.corner=i._isIArea.call(this,a);if(b.corner)return this.trigger("pressed",[b.point]),i._showFoldedPage.call(this,b.corner),!1;b.corner=null}},_eventMove:function(a){var b=this.data().f;if(!b.disabled)if(a=v?a.originalEvent.touches:[a],b.corner){var c=b.parent.offset();b.corner.x=
a[0].pageX-c.left;b.corner.y=a[0].pageY-c.top;i._showFoldedPage.call(this,b.corner)}else b.hover&&!this.data().effect&&this.is(":visible")&&((a=i._isIArea.call(this,a[0]))?(b.status="hover",b=i._c.call(this,a.corner,b.opts.cornerSize/2),a.x=b.x,a.y=b.y,i._showFoldedPage.call(this,a,!0)):"hover"==b.status&&(b.status="",i.hideFoldedPage.call(this,!0)))},_eventEnd:function(){var a=this.data().f,b=a.corner;!a.disabled&&b&&"prevented"!=u("released",this,[a.point||b])&&i.hideFoldedPage.call(this,!0);a.corner=
null},disable:function(a){i.setData.call(this,{disabled:a});return this},hover:function(a){i.setData.call(this,{hover:a});return this},peel:function(a,b){var c=this.data().f;if(a){if(-1==g.inArray(a,i._cAllowed.call(this)))throw p("Corner "+a+" is not permitted");var d=i._c.call(this,a,c.opts.cornerSize/2);c.status="peel";i._showFoldedPage.call(this,{corner:a,x:d.x,y:d.y},b)}else c.status="",i.hideFoldedPage.call(this,b);return this}};window.requestAnim=function(){return window.requestAnimationFrame||
...
(a.from=[a.from]);for(var c=[],d=a.to.length,e=!0,f=this,h=(new Date).getTime(),i=function(){if(b.effect&&e){for(var g=[],j=Math.min(a.duration,(new Date).getTime()-h),l=0;l<d;l++)g.push(b.effect.easing(1,j,a.from[l],c[l],a.duration));a.frame(1==d?g[0]:g);j==a.duration?(delete b.effect,f.data(b),a.complete&&a.complete()):window.requestAnim(i)}},j=0;j<d;j++)c.push(a.to[j]-a.from[j]);b.effect=g.extend({stop:function(){e=!1},easing:function(a,b,c,d,e){return d*Math.sqrt(1-(b=b/e-1)*b)+c}},a);this.data(b);
i()}else delete b.effect}});g.isTouch=v;g.mouseEvents=s;g.cssPrefix=R;g.cssTransitionEnd=function(){var a,b=document.createElement("fakeelement"),c={transition:"transitionend",OTransition:"oTransitionEnd",MSTransition:"transitionend",MozTransition:"transitionend",WebkitTransition:"webkitTransitionEnd"};for(a in c)if(void 0!==b.style[a])return c[a]};g.findPos=D})(jQuery);

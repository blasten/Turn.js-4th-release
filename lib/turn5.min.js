/* turn.js 5-beta0.0.1 | Copyright (c) */

var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.getGlobal=function(a){return"undefined"!=typeof window&&window===a?a:"undefined"!=typeof global&&null!=global?global:a};$jscomp.global=$jscomp.getGlobal(this);var TurnJS=function(a,b){b=void 0===b?"":b;this.jQueryObject=$(a);this.jQueryObject.turn(b);this.__setup__()};TurnJS.prototype.view=function(a){a=void 0===a?this.pages:a;return this.jQueryObject.turn("view",a).filter(function(a){return 0!=a})};
TurnJS.prototype.__setup__=function(){this.pages={__parent__:this,add:function(a,b){b=void 0===b?this.pages+1:b;return this.__parent__.jQueryObject.turn("addPage",$(a),b)},remove:function(a){a=void 0===a?this.page:a;return this.__parent__.jQueryObject.turn("removePage",a)},get pages(){return this.__parent__.jQueryObject.turn("pages")},get zoom(){return this.__parent__.jQueryObject.turn("zoom")},set zoom(a){return this.__parent__.jQueryObject.turn("zoom",a)},get size(){return this.__parent__.jQueryObject.turn("size")},
set size(a){return this.__parent__.jQueryObject.turn("size",a.width,a.height)}};this.animation={__parent__:this,turn:function(a){return this.__parent__.jQueryObject.turn("page",a)},get prev(){return this.__parent__.jQueryObject.turn("previous")},get next(){return this.__parent__.jQueryObject.turn("next")},get running(){return this.__parent__.jQueryObject.turn("animating")},set peel(a){return this.__parent__.jQueryObject.turn("peel",a)}};this.event={__parent__:this,get end(){return this.__parent__.jQueryObject.turn("options").when.end},
set end(a){return this.__parent__.jQueryObject.turn("options",{when:{end:a}})},get first(){return this.__parent__.jQueryObject.turn("options").when.first},set first(a){return this.__parent__.jQueryObject.turn("options",{when:{first:a}})},get last(){return this.__parent__.jQueryObject.turn("options").when.last},set last(a){return this.__parent__.jQueryObject.turn("options",{when:{last:a}})},get missing(){return this.__parent__.jQueryObject.turn("options").when.missing},set missing(a){return this.__parent__.jQueryObject.turn("options",
{when:{missing:a}})},get start(){return this.__parent__.jQueryObject.turn("options").when.start},set start(a){return this.__parent__.jQueryObject.turn("options",{when:{start:a}})},get turning(){return this.__parent__.jQueryObject.turn("options").when.turning},set turning(a){return this.__parent__.jQueryObject.turn("options",{when:{turning:a}})},get turned(){return this.__parent__.jQueryObject.turn("options").when.turned},set turned(a){return this.__parent__.jQueryObject.turn("options",{when:{turned:a}})},
get zooming(){return this.__parent__.jQueryObject.turn("options").when.zooming},set zooming(a){return this.__parent__.jQueryObject.turn("options",{when:{zooming:a}})}};this.settings={__parent__:this,get disabled(){return this.__parent__.jQueryObject.turn("disabled")},set disabled(a){return this.__parent__.jQueryObject.turn("disable",a)},get direction(){return this.__parent__.jQueryObject.turn("direction")},set direction(a){return this.__parent__.jQueryObject.turn("direction",a)},get display(){return this.__parent__.jQueryObject.turn("display")},
set display(a){return this.__parent__.jQueryObject.turn("display",a)},get autoCenter(){return this.__parent__.jQueryObject.turn("options").autoCenter},set autoCenter(a){return this.__parent__.jQueryObject.turn("options",{autoCenter:a})},get duration(){return this.__parent__.jQueryObject.turn("options").duration},set duration(a){return this.__parent__.jQueryObject.turn("options",{duration:a})},get gradients(){return this.__parent__.jQueryObject.turn("options").gradients},set gradients(a){return this.__parent__.jQueryObject.turn("options",
{gradients:a})},get elevation(){return this.__parent__.jQueryObject.turn("options").elevation},set elevation(a){return this.__parent__.jQueryObject.turn("options",{elevation:a})},get turnCorners(){return this.__parent__.jQueryObject.turn("options").turnCorners},set turnCorners(a){return this.__parent__.jQueryObject.turn("options",{turnCorners:a})}}};

...
(function(c){function q(a,b){return a[0]==b[0]?!1:a.attr("page")?!0:a.parent()[0]?q(a.parent(),b):!1}function k(a){function b(a){this.name="TurnJsError";this.message=a}b.prototype=Error();b.prototype.constructor=b;return new b(a)}function r(a,b,e){return e?" translate3d("+a+"px,"+b+"px, 0px) ":" translate("+a+"px, "+b+"px) "}function t(a,b){return b?" scale3d("+a+", "+a+", 1) ":" scale("+a+") "}function l(a,b){return{x:a,y:b}}function p(a,b){return function(){return a.apply(b,arguments)}}var v={max:2,
...
b.trigger("zoom.zoomOut")};0===a?q():(d.on("transitionend",function(){c(this).off("transitionend");q()}),d.transform(r(k.x,k.y,!0)+t(g,!0)));return this}},flipbookWidth:function(){var a=this.data().zoom.opts.flipbook,b=a.turn("view");return"double"!=a.turn("display")||b[0]&&b[1]?a.width():a.width()/2},scroll:function(a,b,e){var d=this.data().zoom,c=d.opts.flipbook,k=this.zoom("flipbookWidth"),f={};f.transition=e?"transform 200ms":"none";c.css(f);c.transform(r(-d.axis.x-a.x,-d.axis.y-a.y,!0));if(!b){b=
l(Math.min(0,(k-this.width())/2),Math.min(0,(c.height()-this.height())/2));c=l(k>this.width()?k-this.width():(k-this.width())/2,c.height()>this.height()?c.height()-this.height():(c.height()-this.height())/2);if(a.y<b.y){a.y=b.y;var h=!0}else a.y>c.y&&(a.y=c.y,h=!0);a.x<b.x?(a.x=b.x,h=!0):a.x>c.x&&(a.x=c.x,h=!0);h&&this.zoom("scroll",a,!0,!0)}d.scrollPos=l(a.x,a.y)},resize:function(){var a=this.data().zoom,b=a.opts.flipbook;if(1<this.zoom("value")){var c=b.offset(),d=this.offset();a.axis=l(c.left-
...
!0);b.draggingCur=a;return!1}},_eMouseUp:function(a){var b=c(this).data().zoom;b.dragging&&c(this).zoom("scroll",b.scrollPos);b.draggingCur=null;setTimeout(function(){b.dragging=!1},1)},_eMouseWheel:function(a){var b=c(this).data().zoom;a=l(b.scrollPos.x+50*a.deltaX,b.scrollPos.y-50*a.deltaY);c(this).zoom("scroll",a,!1,!0)},_eTouchStart:function(a,b){b=c(this).data().zoom;a=l(a.originalEvent.touches[0].pageX,a.originalEvent.touches[0].pageY);b.touch={};b.touch.initial=a;b.touch.last=a;b.touch.timestamp=
(new Date).getTime();b.touch.speed=l(0,0)},_eTouchMove:function(a){var b=c(this).data().zoom,e=c(this).zoom("value"),d=b.opts.flipbook,g=(new Date).getTime();a=l(a.originalEvent.touches[0].pageX,a.originalEvent.touches[0].pageY);b.touch&&1==e&&!d.data().mouseAction&&(b.touch.motion=l(a.x-b.touch.last.x,a.y-b.touch.last.y),b.touch.speed.x=0===b.touch.speed.x?b.touch.motion.x/(g-b.touch.timestamp):(b.touch.speed.x+b.touch.motion.x/(g-b.touch.timestamp))/2,b.touch.last=a,b.touch.timestamp=g)},_eTouchEnd:function(a){a=
c(this).data().zoom;if(a.touch&&1==c(this).zoom("value")){var b=Math.abs(a.touch.initial.y-a.touch.last.y);50>b&&(-1>a.touch.speed.x||-100>a.touch.last.x-a.touch.initial.x)?this.trigger("zoom.swipeLeft"):50>b&&(1<a.touch.speed.x||100<a.touch.last.x-a.touch.initial.x)&&this.trigger("zoom.swipeRight")}},_eDestroying:function(){var a=this,b=this.data().zoom,e=b.opts.flipbook;this.zoom("zoomOut",0);c.each("tap doubleTap resize zoomIn zoomOut swipeLeft swipeRight".split(" "),function(b,c){a.off("zoom."+
c)});for(var d in b.flipbookEvents)Object.prototype.hasOwnProperty.call(b.flipbookEvents,d)&&e.off(d,b.flipbookEvents[d]);e.off("touchstart",b.eventTouchStart).off("touchmove",b.eventTouchMove).off("touchend",b.eventTouchEnd);this.off("touchstart",m._tap).off("click",m._tap);b=null;this.data().zoom=null}};c.extend(c.fn,{zoom:function(){var a=arguments;if(a[0]&&"object"!=typeof a[0]){if(m[a[0]])return m[a[0]].apply(c(this[0]),Array.prototype.slice.call(a,1));throw k(a[0]+" is not a method");}return m.init.apply(c(this[0]),
a)}})})(jQuery);
